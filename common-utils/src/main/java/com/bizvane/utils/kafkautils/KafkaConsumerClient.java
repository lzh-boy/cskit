...
public class KafkaConsumerClient<K> {
    ...
    private com.bizvane.utils.kafkautils.ConsumerConfig consumerConfig;

    @Autowired
    public KafkaConsumerClient(com.bizvane.utils.kafkautils.ConsumerConfig consumerConfig) {
